...
var player1 = prompt("Jogador 1 insira seu nome , Você será AZUL");
var player1Color = 'rgb(86, 151, 255)';

var player2 = prompt("Jogador 2 insira seu nome , Você será VERMELHO");
...
function gameEnd(winningPlayer) {
  for (var col = 0; col < 7; col++) {
    for (var row = 0; row < 7; row++) {
      $('h3').fadeOut('fast');
      $('h2').fadeOut('fast');
      $('h1').text(winningPlayer+" Ganhou! Atualize a página para começar de novo").css("fontSize", "50px")
    }
  }
}
...
// Start with Player One
$('h3').text(player1+": é a sua vez, Por favor escolha uma coluna para largar seu círculo AZUL.");
...
$('.board button').on('click',function() {
  ...
  if (currentPlayer === 1) {
    currentName = player1;
    $('h3').text(currentName+": é a sua vez, Por favor escolha uma coluna para largar seu círculo AZUL.");
    currentColor = player1Color;
  }else {
    currentName = player2
    $('h3').text(currentName+": é a sua vez, Por favor escolha uma coluna para largar seu círculo VERMELHO.");
